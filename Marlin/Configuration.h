...
#define CUSTOM_MACHINE_NAME "Bidouilleur"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Anet Default with silicon cover
  #define DEFAULT_Kp 22.64
  #define DEFAULT_Ki 1.13
  #define DEFAULT_Kd 113.0
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //120V 80 celcius, Anycubic surface from pidautotune ( M303 )
  #define DEFAULT_bedKp 79.59
  #define DEFAULT_bedKi 15.90
  #define DEFAULT_bedKd 265.55
